...
if(${PCSX2_TARGET_ARCHITECTURES} MATCHES "x86_64" OR ${PCSX2_TARGET_ARCHITECTURES} MATCHES "i386" OR ${PCSX2_TARGET_ARCHITECTURES} MATCHES "^arm")
...
elseif(${PCSX2_TARGET_ARCHITECTURES} MATCHES "x86_64")
    ...
    set(_M_X86 1)
    set(_M_X86_64 1)
elseif(${PCSX2_TARGET_ARCHITECTURES} MATCHES "arm" OR ${PCSX2_TARGET_ARCHITECTURES} MATCHES "arm64")
    # CheckMe: Other architectures to handle?
    set(CMAKE_THREAD_PREFER_PTHREAD ON)
    set(THREADS_PREFER_PTHREAD_FLAG ON)
    set(ARCH_FLAG "-march=armv7-a") # -mcpu=native")
...
if(${PCSX2_TARGET_ARCHITECTURES} MATCHES "^arm")
